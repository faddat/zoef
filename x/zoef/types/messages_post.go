...
func NewMsgCreatePost(creator string, titel string, corpus string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id string, titel string, corpus string) *MsgUpdatePost {
